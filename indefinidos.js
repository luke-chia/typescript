...
function holaInd(saludo, ...numero) {
    console.log(typeof saludo);
    console.log(typeof numero);
    return "Hola";
}
console.log(holaInd("Lukin"));
var esNulo = function (value) {
    return !value && typeof value === "object";
};
var esNumerico = function (value) {
    return !isNaN(value);
};
